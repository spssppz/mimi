		...
		<section className="pt-22.5 lg:pt-27.5 bg-white">
			<div className="max-w-236 mx-auto px-4 -tracking-[0.01em]">
				<div className="mb-4">
					...
					<h2 className="mb-6 tracking-0 font-bold text-[64px] md:text-[100px] lg:text-[140px] xl:text-[220px] bg-[linear-gradient(180deg,#0b0d10_0%,#6bf980_100%)] bg-clip-text text-transparent leading-tight flex flex-col">
						Резерв
