	...
	return (
		<section className="pt-22.5 lg:py-30 relative bg-white">
			...
			<div className="max-w-308 mx-auto px-4">
				...
				<div className="relative max-w-165 font-helvetica text-[17px] md:text-[18px] lg:text-[20px] tracking-[-0.01em] mb-10 lg:mb-20">
				...
				<div className="hidden! lg:flex relative">
					...
					<div className="w-90 flex-none pl-8">
						<div>
						</div>
						<div>
							<div className="font-bold text-[64px] leading-tight">50+</div>
							<p className="font-helvetica -tracking-[0.01em]">филиалов по всему миру</p>
						</div>
					</div>
					<div className="flex-auto pl-8">
						<ul>
							<div>
								...
								<p className="font-helvetica -tracking-[0.01em]">дизайнеров и дилеров рекомендуют систему MimiSmart</p>
							</div>
							<div>
