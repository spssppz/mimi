	...
	return (
		<section className="bg-foreground overflow-hidden">
			<div className="py-22.5 lg:py-0 max-w-308 mx-auto px-4 flex lg:items-center flex-col lg:flex-row gap-20 lg:gap-10 justify-between">
				<div className="lg:py-20 flex-none lg:w-110 xl:w-135">
				...
				<div className="relative xl:-mr-20 flex lg:flex-row flex-col gap-2.5 lg:max-h-195 px-4 -mx-4 lg:px-0 lg:mx-0">
