...
export default function WindowBlindEngine() {
	return (
		<section className="pt-22.5 max-lg:pb-22.5 overflow-hidden">
			<div className="max-w-235.5 px-4 mx-auto">
				<Title className="max-w-131">Электропривод
					в карнизе</Title>
				<div className="lg:flex lg:items-center lg:justify-between -mt-20 lg:-mt-10">
					<div className="relative max-lg:max-w-157.5 -ml-50 lg:grow-0 lg:shrink-0 lg:-ml-[44.7%] lg:basis-[110%] aspect-1005/984">
						<Image
							fill
							alt=""
							src="/images/window-blind-page/engine.png"
							quality={95}
						/>
					</div>
