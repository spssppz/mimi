...
export default function DetectorExample({ example }: Props) {
	...
	return (
		<div className={`${example.bg} pt-10 md:pt-15 lg:pt-22.5 pb-15 md:pb-22.5 lg:pb-30`}>
			<div className="max-w-308 px-4 mx-auto">
				<div className={`${example.bodyClasses} max-lg:flex-col px-4 md:px-10 lg:px-20 pt-10 lg:py-15 flex justify-between gap-10 items-center`}>
