		...
		<section className="py-22.5 lg:py-30">
			<div className="max-w-235.5 px-4 mx-auto">
				...
				<ul className="grid md:grid-cols-2 gap-5 text-[22px] md:text-[28px] lg:text-[32px]">
					...
					<li className="md:min-h-150 rounded-3xl text-white gap-25 bg-[#504a3f] max-md:p-6 md:px-15 md:py-9.25 flex flex-col-reverse items-center">
					...
					<li className="md:min-h-150 rounded-3xl bg-white max-md:p-6 md:px-4 md:py-9.25 flex flex-col items-center gap-17.5">
						<h3 className="font-semibold leading-[1.3] -tracking-[0.01em]">
							Смета за 24 часа
						</h3>
						<Image
